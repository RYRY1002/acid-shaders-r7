...
//colors for shadows/sunlight and sky
	...
	vec3 noon_sun;
	 noon_sun.r = mix(1.00, 4.00, rayleigh);
	 noon_sun.g = mix(1.00, 1.75, rayleigh);
	...
	sunrise_amb = vec3(3.0f, 2.5f, 0.1f) * 0.10f;
